            ...
            <div className='w-full max-w-md m-auto bg-white rounded-lg border border-primaryBorder shadow-default py-10 px-16'>
                {
                    isSigningUp ?
                        <form onSubmit={handleFormSubmit}>
                            ...
                            <input className={`font-serif w-full p-2 text-primary border rounded-md outline-none text-sm transition duration-150 ease-in-out mb-4`} type="text" name="institution_name" value={formData.name} onChange={handleFormChange} placeholder="Organization Name"></input>
