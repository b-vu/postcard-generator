...
var buildEditor = function buildEditor(canvas, fillColor, strokeColor, _setFillColor, _setStrokeColor, scaleStep) {
  return {
    ...
    addCircle: function addCircle() {
      var object = new fabric.Circle(_extends({}, CIRCLE, {
        fill: fillColor,
        stroke: strokeColor
      }));
      canvas.add(object);
    ...
    addRectangle: function addRectangle() {
      var object = new fabric.Rect(_extends({}, RECTANGLE, {
        fill: fillColor,
        stroke: strokeColor
      }));
      canvas.add(object);
    ...
    addLine: function addLine() {
      var object = new fabric.Line(LINE.points, _extends({}, LINE.options, {
        stroke: strokeColor
      }));
      canvas.add(object);
    },
    addText: function addText(text) {
      var object = new fabric.Textbox(text, _extends({}, TEXT, {
        fill: strokeColor
      }));
      object.set({
        text: text
...
var useFabricJSEditor = function useFabricJSEditor(props) {
  ...
  var _useState2 = useState(defaultFillColor || FILL),
      fillColor = _useState2[0],
      setFillColor = _useState2[1];

  var _useState3 = useState(defaultStrokeColor || STROKE),
